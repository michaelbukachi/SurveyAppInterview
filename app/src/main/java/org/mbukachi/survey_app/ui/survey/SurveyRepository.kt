    ...
    Question(
        ...
        answer = PossibleAnswer.SingleChoiceIcon(
            optionsStringIconRes = listOf(
                Pair(R.drawable.ic_android_black_24dp, R.string.spark),
                Pair(R.drawable.ic_android_black_24dp, R.string.lenz),
                Pair(R.drawable.ic_android_black_24dp, R.string.bugchaos),
                Pair(R.drawable.ic_android_black_24dp, R.string.frag)
            )
        ),
